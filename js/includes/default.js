...
$('#head-nav-bar').append(`
    <nav class="navbar navbar-default" role="navigation" aria-label="main navigation">
        <div class="container-fluid">
            ...
            <div class="navbar-header" aria-label="About us">
            ...
            <ul class="nav navbar-nav navbar-right" role="navigation" aria-label="account navigation">
                <li><a href="account.html" class="p-username" aria-label="account settings" ><span class="glyphicon glyphicon-user"></span></a></li>
